...
const HireMe = () => {
    ...
    return (
        <>
            <button onClick={() => setOpen(!open)}  className='btn bg-success bg-success inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto'>Hire me</button>
                                            ...
                                            <div className="mt-3  sm:ml-4 sm:mt-0 sm:text-left">
                                                ...
                                                <div className="mt-2">
                                                    <p className="text-sm text-gray-500">
                                                        An Engineer majored individual with practical hands-on-approach in MERN stcak. Self taught in Full Stack Develoment technologies.
