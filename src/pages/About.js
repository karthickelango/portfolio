...
const Home = () => {
  TabTitle("Home");
  const string = [
    "frontend developer in React.", "full stack in MERN wait...", "also frontend developer in Vue.", "and full stack in MEVN."
  ]
  return (
    <>
            ...
            <div className="col-6">
              ...
              <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                <p className="secondary-color">
                  As a seasoned frontend engineer, I bring a robust skill set in
                  web development, specializing in Angular, React, JavaScript,
                  MERN stack (MongoDB, Express.js, React.js, Node.js),
                  Bootstrap, and Tailwind CSS. With extensive experience in
                  crafting dynamic and responsive user interfaces, I thrive on
                  translating design concepts into seamless and intuitive
                  digital experiences.
                </p>
                <p className="secondary-color">
                  My proficiency in Angular and React enables me to architect
                  scalable and maintainable frontend solutions, while my
                  expertise in JavaScript empowers me to implement complex
                  functionalities with efficiency and precision.
                </p>
                <p className="secondary-color">
                  Moreover, my adeptness in utilizing Bootstrap and Tailwind CSS
                  ensures that my designs are not only visually appealing but
                  also optimized for performance across various devices and
                  screen sizes. Combining these skills, I am equipped to tackle
                  diverse frontend challenges and deliver high-quality solutions
              ...
              <div className="lg:pl-20 dis-mob-none">
                <ul>
                  <li className="pt-8 ">
                    ...
                    >
                      <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                        className="h-6 w-6 flex-none fill-zinc-500 transition "
                      >
                  ...
                  <li className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                    ...
                    >
                      <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                        class="h-6 w-6 flex-none fill-zinc-500 transition"
                      >
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                  ...
                  <li className="mt-8 text-cente">
                    ...
                    <button
                      type="button"
                      className="bg-success download-btn inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto"
                    >
                      <Link
                        to="/file/karthickElango.pdf"
                        target="_blank"
                        download
                      >
                        Download
              ...
              <div className="lg:pl-20">
                <ul>
                  ...
                  <li className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                    <a
                      className="align-item-center group flex text-sm font-medium text-zinc-800 transition hover dark:text-zinc-200 dark"
                      href="mailto:karthik5ive@gmial.com"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
